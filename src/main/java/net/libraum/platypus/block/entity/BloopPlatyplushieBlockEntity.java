...
public class BloopPlatyplushieBlockEntity extends BlockEntity implements GeoBlockEntity {
    private static final RawAnimation BOUNCE = RawAnimation.begin().thenPlay("animation.platyplushie_block.bounce");
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public BloopPlatyplushieBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.BLOOP_PLATYPLUSHIE_BLOCK_ENTITY, pos, state);
