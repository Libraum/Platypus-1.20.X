...
public class DarkPlatyplushieBlockEntity extends BlockEntity implements GeoBlockEntity {
    private static final RawAnimation BOUNCE = RawAnimation.begin().thenPlay("animation.platyplushie_block.bounce");
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public DarkPlatyplushieBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.DARK_PLATYPLUSHIE_BLOCK_ENTITY, pos, state);
